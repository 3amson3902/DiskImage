"""
gui/app.py - GUI entry point and application for DiskImage
"""
...
from main import is_admin, list_disks
...
class DiskImagerApp(tk.Tk):
    ...
    def create_widgets(self):
        ...
        self.archive_type_var = tk.StringVar(value="7z")
