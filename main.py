...
def list_disks_windows():
    """List available physical disks using WMIC on Windows."""
    ...
    try:
        ...
        print(f"Error listing disks with WMIC: {e}", file=sys.stderr)
        return None
    except Exception as e:
        print(f"An unexpected error occurred while parsing disk list: {e}", file=sys.stderr)
        return None
